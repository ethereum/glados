...
function getCurrentSubprotocol() {
  ...
  subprotocols = {
    history: {
      baseUrl: "api/stat-history/?weeks-ago=",
      keys: [
        "success_rate_all",
        "success_rate_latest",
        "success_rate_random",
    ...
    state: {
      baseUrl: "api/stat-state/?weeks-ago=",
      keys: ["success_rate_state_latest", "success_rate_state_state_roots"],
      selectedIndexes: [1],
      labels: ["Latest", "State Roots"],
    },
    beacon: {
      baseUrl: "api/stat-beacon/?weeks-ago=",
      keys: ["success_rate_beacon_latest"],
      selectedIndexes: [0],
      labels: ["Latest"],
    },
  };
