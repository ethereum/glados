  ...
  return (function () {
  ...
  })()(
    {
              ...
              class ENR extends Map {
                ...
                static decodeFromValues(decoded) {
                  ...
                  if (decoded.length % 2 !== 0) {
                    throw new Error(
                      "Decoded ENR must have an even number of elements",
                    );
                  }
                  ...
                  return {
                    enr,
                    seq: seq_buffer.readIntBE(0, seq_buffer.length),
                    signature,
                  };
                }
                ...
                static decodeTxt(encoded) {
                  ...
                  return ENR.decode(
                    base64url_1.default.toBuffer(encoded.slice(4)),
                  );
                }
                get ip() {
                  const raw = this.get("ip");
                  if (raw) {
                    return toNewUint8Array(raw)
                      .reduce((acc, n) => {
                        acc.push(n);
                        return acc;
                      }, [])
      ...
      6: [
        ...
        { "base64-js": 2, buffer: 6, ieee754: 7 },
      ],
      7: [
        function (require, module, exports) {
