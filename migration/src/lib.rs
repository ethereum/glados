...
mod m20230127_162559_create_execution_body_table;
mod m20230127_162626_create_execution_receipts_table;
...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(m20230127_162559_create_execution_body_table::Migration),
            Box::new(m20230127_162626_create_execution_receipts_table::Migration),
        ]
    }
}
